nockforge zkminer 0.5.2 -- GPU miner for Nockchain (proof-version 5, Anthropos)
================================================================================
Linux x86_64, NVIDIA.

1. QUICK START
--------------
    sha256sum nockforge-zkminer-0.5.2.tar.gz     # compare with the site
    tar xzf nockforge-zkminer-0.5.2.tar.gz && cd nockforge-zkminer-0.5.2
...
GPU     NVIDIA, Ampere or newer. Precompiled kernel images ship for compute
        ...
        only on the RTX 5090 (103 M nonces/s at a 600 W board limit, 100 M at
        540 W); other
...
-----------------------------------
    ...
    LOCAL 103586814 cand/s (103.59 M nonces/s) | 60s 103.61 M/s | GPU 76 C 600 W | shares 350 accepted 0 rejected | hits 350 | ...
